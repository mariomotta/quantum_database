...
for depth in depth_list:
    for dist in dist_list:
        ...
        H_fci,S_fci,nqubit = trim(H_fci,S_fci)
        
        H_op = matrix_to_qubit_operator(H_fci)
        Proj = np.eye(H_fci.shape[0])
        ...
        p0 = np.loadtxt('/Users/mario/Documents/GitHub/QITE/qite_es/first_quantization_trim/beh2/cascade_depth_%d/R_%s/output_parameters.txt'%(depth,str(dist)))
        ...
        print_results('cascade_%d/beh2_%s_results.txt' % (depth,str(dist)),res_vqe,res_ee)
