...
for depth in depth_list:
    for dist in dist_list:
        ...
        p0 = np.loadtxt('/Users/mario/Documents/GitHub/QITE/qite_es/first_quantization_trim/bh/cascade_depth_%d/R_%s/output_parameters.txt'%(depth,str(dist)))
        ...
        print_results('cascade_%d/bh_%s_results.txt' % (depth,str(dist)),res_vqe,res_ee)
