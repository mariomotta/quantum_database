...
def custom_plot(ax,style,d,x,y):
    ax.plot(x,y,color=style[str(d)]['color'],ls=style[str(d)]['s'],marker=style[str(d)]['marker'],label=style[str(d)]['label'],ms=1)
...
for c in [0,1,2,3]:
    ...
    fill_panel(ax[4,c],r'$R$ $[\AA]$',[0.5,3.5],[0.5,1.5,2.5,3.5],['0.5','1.5','2.5','3.5'],yl,[-0.04,0.04],[-0.04,-0.02,0.00,0.02,0.04],lab)
    # ---------------- 
