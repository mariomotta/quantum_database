...
for j,mol in enumerate(['bh','hf','beh2','h2o']):
    ...
    print(mol)
    #data_mol = np.load('data_%s.npy'%mol,allow_pickle=True).item()
...
fill_panel(ax[1,0],'',[0.5,5.5],[0.5,1.5,2.5,3.5,4.5,5.5],['','','','','',''],
                   r'$E-E_{\mathrm{FCI,trim}}$ [m$\mathrm{E_h}$]',[0.0000,0.0001],[0,2.5e-5,5e-5,7.5e-5,1e-4],['0.000','0.025','0.050','0.075','0.100'])
fill_panel(ax[2,0],r'$R$ [\AA]',[0.5,5.5],[0.5,1.5,2.5,3.5,4.5,5.5],[0.5,1.5,2.5,3.5,4.5,5.5],
                   r'$E_{\mathrm{FCI,trim}}-E_{\mathrm{FCI}}$ [m$\mathrm{E_h}$]',[0.0000,0.0003],[0,1e-4,2e-4,3e-4],['0.0','0.1','0.2','0.3'])
...
fill_panel(ax[2,2],r'$R$ [\AA]',[0.5,4.5],[0.5,1.5,2.5,3.5,4.5],[0.5,1.5,2.5,3.5,4.5],
                   r'$E_{\mathrm{FCI,trim}}-E_{\mathrm{FCI}}$ [m$\mathrm{E_h}$]',[0.0000,0.003],[0,1e-3,2e-3,3e-3],['0.0','1.0','2.0','3.0'])
