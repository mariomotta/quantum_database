...
for dist in dist_list:
    ...
    write_to_file(H_op,offsets[0],'hf_%s_h.txt'%dist)
    write_to_file(A_op[0],offsets[1],'hf_%s_ne.txt'%dist)
    write_to_file(A_op[1],offsets[2],'hf_%s_s2.txt'%dist)
    write_to_file(A_op[2],offsets[3],'hf_%s_sz.txt'%dist)
