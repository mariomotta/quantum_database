...
for depth in [1,2]:
  for dist in dist_list:
    ...
    if(depth==1):
       ...
       p0 = np.loadtxt('/Users/mario/Documents/GitHub/QITE/qite_es/scf_calculations/qUCCSD/h2o/R_%s/output_parameters.txt' % str(dist))
    else:
       ...
       p0 = np.loadtxt('/Users/mario/Documents/GitHub/QITE/qite_es/scf_calculations/qUCCSD/h2o_reps2/R_%s/output_parameters.txt' % str(dist))
