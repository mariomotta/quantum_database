...
for depth in depth_list:
  for dist in dist_list:
    ...
    par = np.loadtxt('/Users/mario/Documents/GitHub/QITE/qite_es/scf_calculations/scf_calculations/Ry_linear_DEPTH_%d/hf/R_%s/output_parameters.txt' % (depth,str(dist)))
    ...
    print_results('ry_linear_%d/hf_%s_results.txt' % (depth,str(dist)),res_vqe,res_ee,dN=2)
